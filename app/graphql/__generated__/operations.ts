...
export type LandingQuery = { landing: { totalGames: number, featured: { clipUrl: string | null, game: { slug: string, name: string, released: string | null, platformFamilies: Array<PlatformFamily>, cover: { url: string } | null } } | null } };
